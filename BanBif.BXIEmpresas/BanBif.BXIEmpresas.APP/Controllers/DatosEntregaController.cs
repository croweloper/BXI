...
namespace BanBif.BXIEmpresas.APP.Controllers
{
    public class DatosEntregaController : Controller
    {
        ...
        {
            string apiBaseUrl = ConfigurationManager.AppSettings.Get("UrlAPI").ToString();
            string apiUrl = apiBaseUrl + "api/Empresa/ActualizarEntrega";
            var result = new HttpResponseMessage();
            using (var client = new HttpClient())
            {
                var jsonObject = JsonConvert.SerializeObject(request);
        ...
        {
            string apiBaseUrl = ConfigurationManager.AppSettings.Get("UrlAPI").ToString();
            string apiUrl = apiBaseUrl + "api/Empresa/ObtenerDatoEntrega";
            var result = new HttpResponseMessage();
            using (var client = new HttpClient())
            {
                var jsonObject = JsonConvert.SerializeObject(request);
        ...
        {
            string apiBaseUrl = ConfigurationManager.AppSettings.Get("UrlAPI").ToString();
            string apiUrl = apiBaseUrl + "api/Empresa/ObtenerRegistro";
            var result = new HttpResponseMessage();
            using (var client = new HttpClient())
            {
        ...
        public string CuerpoHTML(int id, string token)
        {
            ...
            html += "<p>Podrá acceder a su Solicitud de Afiliación <a href='" + rutaapp + "/resumen?sol=" + id + "&token=" + token + "'>aquí</a></p>";
